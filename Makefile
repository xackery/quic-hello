...
ifeq (,$(wildcard ./bin/cacert.pem))
	...
	openssl req -new -x509 -key bin/cakey.pem -out bin/cacert.pem -days 1095 -subj "/C=US/ST=CA/L=San Francisco/O=My Company/OU=Org/CN=localhost" -addext "subjectAltName = DNS:localhost"
endif